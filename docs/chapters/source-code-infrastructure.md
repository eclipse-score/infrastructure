...
- Shared conventions are emerging, but not yet uniformly synchronized; [chapter 4](static-analysis-infrastructure.md) is the canonical home for static-analysis tooling and rule-baseline details.
